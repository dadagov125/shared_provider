...
class SharedInstance<T> {
  ...
  factory SharedInstance.acquire({
    required T Function() createValue,
  ...
  static void releaseIfAcquired(String instanceKey, Object acquirer) {
    final instance = _container[instanceKey];
    instance?.release(acquirer);
  }
